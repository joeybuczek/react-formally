...
var Submit = function Submit(_ref) {
  var ariaLabel = _ref.ariaLabel,
      ...
      resetAfterSubmit = _ref.resetAfterSubmit,
      style = _ref.style,
      title = _ref.title,
      _ref$value = _ref.value,
      value = _ref$value === undefined ? "Submit" : _ref$value,
      rest = _objectWithoutProperties(_ref, ["ariaLabel", "className", "disabled", "id", "inline", "hidden", "name", "resetAfterSubmit", "style", "title", "value"]);
