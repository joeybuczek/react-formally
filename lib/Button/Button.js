...
var Button = function Button(_ref) {
  var ariaLabel = _ref.ariaLabel,
      ...
      value = _ref$value === undefined ? "Custom" : _ref$value,
      rest = _objectWithoutProperties(_ref, ["ariaLabel", "children", "className", "disabled", "id", "inline", "hidden", "name", "onClick", "style", "title", "type", "value"]);
