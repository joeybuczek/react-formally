...
var Select = function Select(_ref) {
  var ariaLabel = _ref.ariaLabel,
      ...
      style = _ref.style,
      rest = _objectWithoutProperties(_ref, ["ariaLabel", "className", "children", "disabled", "fieldClassName", "fieldStyle", "hidden", "id", "inline", "label", "labelBelow", "name", "onChange", "options", "required", "requiredLabel", "style"]);
